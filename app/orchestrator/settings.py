...
AI_ENGINE_PLATFORM_VARS_CONFIG_MAP_NAME = os.getenv('AI_ENGINE_PLATFORM_VARS_CONFIG_MAP_NAME', 'ai-engine-config')
AI_ENGINE_PLATFORM_VARS_INPUT_ELEMENTS = os.getenv('AI_ENGINE_PLATFORM_VARS_INPUT_ELEMENTS', '/tmp/input_elements/')
AI_ENGINE_PLATFORM_VARS_INPUT_DATA_TRAINING_TABULAR = os.getenv('AI_ENGINE_PLATFORM_VARS_INPUT_DATA_TRAINING_TABULAR', '/tmp/input_elements/platform_data/')
AI_ENGINE_PLATFORM_VARS_INPUT_DATA_TRAINING_IMAGERY = os.getenv('AI_ENGINE_PLATFORM_VARS_INPUT_DATA_TRAINING_IMAGERY', '/tmp/input_elements/platform_data/')
AI_ENGINE_PLATFORM_VARS_INPUT_DATA_EVALUATION_TABULAR = os.getenv('AI_ENGINE_PLATFORM_VARS_INPUT_DATA_EVALUATION_TABULAR', '/tmp/input_elements/platform_data/')
AI_ENGINE_PLATFORM_VARS_INPUT_DATA_EVALUATION_IMAGERY = os.getenv('AI_ENGINE_PLATFORM_VARS_INPUT_DATA_EVALUATION_IMAGERY', '/tmp/input_elements/platform_data/')
...
AI_ENGINE_PLATFORM_VARS_INPUT_DATA_INFERENCE_REPORT_METADATA = os.getenv('AI_ENGINE_PLATFORM_VARS_INPUT_DATA_INFERENCE_REPORT_METADATA', '/tmp/input_elements/external_data/report_metadata.json')
...
AI_ENGINE_PLATFORM_VARS_INPUT_ELEMENTS_REPORT_METADATA = os.getenv('AI_ENGINE_PLATFORM_VARS_INPUT_ELEMENTS_REPORT_METADATA', '/tmp/input_elements/report_metadata.json')
...
AI_ENGINE_PLATFORM_VARS_API_END_URL = os.getenv('AI_ENGINE_PLATFORM_VARS_API_END_URL', '/api/end')
AI_ENGINE_PLATFORM_VARS_API_HOST = os.getenv('AI_ENGINE_PLATFORM_VARS_API_HOST', '127.0.0.1:8001')

PLATFORM_CENTRAL_NODE_LABEL_KEY = os.getenv('PLATFORM_CENTRAL_NODE_LABEL_KEY', 'cloudNode')
PLATFORM_CENTRAL_NODE_LABEL_VALUE = os.getenv('PLATFORM_CENTRAL_NODE_LABEL_VALUE', 'cloudNode')
