...
public class TestCreateOutputModelDirectory {

    public JSONObject createOutputModelDirectoryAction;
    ...
    public void before() throws Exception {
        // create config
        createOutputModelDirectoryAction = new JSONObject(
                "{" +
    ...
    @Test
    public void createOutputModelDirectorySuccess() throws Exception {
        JSONArray actions = new JSONArray();
        actions.put(createOutputModelDirectoryAction);
        ...
        assertEquals(List.of("model"), directoryFiles);
    }

    @Test
    public void createOutputModelDirectoryBadFormatted() throws Exception {
        createOutputModelDirectoryAction = new JSONObject(
                "{" +
                        "\"nothing\":\"create_output_model_directory\"" +
                        "}"
        );
