...
# main attributes
name="d_4_2_service_prostate_cancer_mri" # str
...
description="A schema that performs the Prostate Cancer MRI Service from D.4.2, creating a set of results and charts"
