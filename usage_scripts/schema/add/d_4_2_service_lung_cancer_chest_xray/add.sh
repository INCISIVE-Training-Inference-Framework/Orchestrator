...
auxiliary_file="./auxiliary_files/schema_d_4_2_service_lung_cancer_chest_xray/schema.yaml" # FILE, optional (it is mandatory for the argo_workflows implementation)
...
_1_input_ai_engine_descriptor="classification" # str, cannot contain spaces or special symbols
_1_input_ai_engine_role_type="classification" # str, possible values -> the ones defined on the MaaS along the symbol *
