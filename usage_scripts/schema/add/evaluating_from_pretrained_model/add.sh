...
# main attributes
name="evaluating_from_pretrained_model" # str
...
auxiliary_file="./auxiliary_files/schema_evaluating_from_pretrained_model/schema.yaml" # FILE, optional (it is mandatory for the argo_workflows implementation)
...
input_ai_engine_functionalities='["evaluating_from_pretrained_model"]' # list[str], possible values -> the ones defined on the MaaS
