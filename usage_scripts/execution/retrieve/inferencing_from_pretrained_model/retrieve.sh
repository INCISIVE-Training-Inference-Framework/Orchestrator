...
# --> DESCRIPTION
# It is a script that retrives an Execution of the schema "inferencing_from_pretrained_model" from the Orchestrator. It shows the different outputs depending on the status of the Execution.
