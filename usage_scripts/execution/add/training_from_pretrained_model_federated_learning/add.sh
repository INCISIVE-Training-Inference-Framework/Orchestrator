...
# --> DESCRIPTION
# It is a script that creates an Execution from the "traning_from_pretrained_model_federated_learning" Schema of the Orchestrator
...
# main attributes
schema="training_from_pretrained_model_federated_learning" # str
