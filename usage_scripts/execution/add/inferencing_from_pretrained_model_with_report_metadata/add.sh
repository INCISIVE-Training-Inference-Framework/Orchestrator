...
# main attributes
schema="inferencing_from_pretrained_model_with_report_metadata" # str

# input attributes

input_external_data="./auxiliary_files/external_data.zip" # FILE
input_report_metadata="./auxiliary_files/report_metadata.json"
# AI logic attributes
...
curl -X POST http://${orchestrator_api_hostname}/api/executions/ \
                            ...
                            -F report_metadata=@${input_report_metadata} \
